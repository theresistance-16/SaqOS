...
help_out: db "All Commands: src, help, exit, saqver, panic, echo. (USE PANIC CAREFULLY!, IT PANICS THE KERNEL!) (more commands to come and direct ring 0 lib calls) also, just type echo and then you will get a prompt on what you want to echo.", 0
src_out: db "Source Code: https://github.com/theresistance-16/SaqOS", 0
saqver_out: db "SaqKernel Version: 4 Saqbootloader version: 4", 0
